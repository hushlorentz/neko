...
TEST_CASE("EE truncating packed pack execution")
{
  struct Contract
  {
    std::uint8_t nestedFunction;
  ...
  const EERegister128 source = {
    UINT64_C(0xa313a212a111a010),
    UINT64_C(0xa717a616a515a414)
  };
  const EERegister128 target = {
    UINT64_C(0xb323b222b121b020),
    UINT64_C(0xb727b626b525b424)
  };
  const Contract contracts[] = {
    {
      0x1b,
    ...
    },
    {
      0x17,
      {
        UINT64_C(0xb626b424b222b020),
        UINT64_C(0xa616a414a212a010)
      }
    },
    {
      0x13,
      {
        UINT64_C(0xb525b424b121b020),
        UINT64_C(0xa515a414a111a010)
      }
    }
  };
  ...
  SECTION("Aliases capture both operands and register zero is immutable")
  {
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x08, 0x1b, 1, 2, 1));
    REQUIRE(
      core.generalRegister(1) ==
      EERegister128{UINT64_C(0x2726252423222120),
                    UINT64_C(0x1716151413121110)});
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x08, 0x17, 1, 2, 2));
    REQUIRE(
      core.generalRegister(2) ==
      EERegister128{UINT64_C(0xb626b424b222b020),
                    UINT64_C(0xa616a414a212a010)});

    runInstruction(
      &system,
      nestedMmiInstruction(0x08, 0x13, 1, 2, 0));
    REQUIRE(core.generalRegister(0) == EERegister128{});
  }
  ...
  SECTION("Repeated execution replaces every destination lane")
  {
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x08, 0x1b, 1, 2, 3));
...
TEST_CASE("EE packed exchange execution")
{
  ...
  const Contract contracts[] = {
    {
      ...
      0x1a,
      {
        UINT64_C(0xa003a000a001a002),
        UINT64_C(0xa007a004a005a006)
      }
    },
    {
      0x29,
      0x1a,
      {
        UINT64_C(0xa003a001a002a000),
        UINT64_C(0xa007a005a006a004)
      }
    },
    {
      0x09,
    ...
    },
    {
      ...
      0x1e,
      {
        UINT64_C(0xa005a004a001a000),
        UINT64_C(0xa007a006a003a002)
      }
    }
  };
  ...
  SECTION("Target alias captures every source lane")
  {
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x09, 0x1a, 0, 2, 2));
    REQUIRE(
      core.generalRegister(2) ==
      EERegister128{UINT64_C(0xa003a000a001a002),
                    UINT64_C(0xa007a004a005a006)});
  }
  ...
  SECTION("Register zero is immutable")
  {
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x29, 0x1e, 0, 2, 0));
    REQUIRE(core.generalRegister(0) == EERegister128{});
  }
  ...
  SECTION("Repeated execution replaces every destination lane")
  {
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x29, 0x1a, 0, 2, 3));
...
TEST_CASE("EE immediate packed halfword shift execution")
{
  struct Contract
  {
    std::uint8_t function;
  ...
  const EERegister128 target = {
    UINT64_C(0xffff7fff80010001),
    UINT64_C(0xff0000ff80001234)
  };
  const Contract contracts[] = {
    {
      0x34,
      {
        UINT64_C(0xfffefffe00020002),
        UINT64_C(0xfe0001fe00002468)
      }
    },
    {
      0x36,
      {
        UINT64_C(0x7fff3fff40000000),
        UINT64_C(0x7f80007f4000091a)
      }
    },
    {
      0x37,
      {
        UINT64_C(0xffff3fffc0000000),
        UINT64_C(0xff80007fc000091a)
      }
    }
  };
  ...
  SECTION("Zero shift preserves every lane")
  {
    NekoSystem system;
    EECore &core = system.eeCore();
    core.setGeneralRegister(2, target);
    runInstruction(
      &system,
      nestedMmiInstruction(0x37, 0, 0, 2, 3));
    REQUIRE(core.generalRegister(3) == target);
  }

  SECTION("Maximum arithmetic shift broadcasts each sign")
  {
    NekoSystem system;
    EECore &core = system.eeCore();
    core.setGeneralRegister(2, target);
    runInstruction(
      &system,
      nestedMmiInstruction(0x37, 15, 0, 2, 3));
    REQUIRE(
      core.generalRegister(3) ==
      EERegister128{UINT64_C(0xffff0000ffff0000),
                    UINT64_C(0xffff0000ffff0000)});
  }
  ...
  SECTION("Target alias is safe and register zero is immutable")
  {
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x36, 1, 0, 2, 2));
    REQUIRE(
      core.generalRegister(2) ==
      EERegister128{UINT64_C(0x7fff3fff40000000),
                    UINT64_C(0x7f80007f4000091a)});

    runInstruction(
      &system,
      nestedMmiInstruction(0x34, 1, 0, 2, 0));
    REQUIRE(core.generalRegister(0) == EERegister128{});
  }
  ...
  SECTION("Repeated execution replaces every destination lane")
  {
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x34, 1, 0, 2, 3));
...
TEST_CASE("EE immediate packed word shift execution")
{
  struct Contract
  {
    std::uint8_t function;
  ...
  const EERegister128 target = {
    ...
    UINT64_C(0xff0000ff7fffffff)
  };
  const Contract contracts[] = {
    {
      0x3c,
      {
        UINT64_C(0x0000000200000002),
        UINT64_C(0xfe0001fefffffffe)
      }
    },
    {
      0x3e,
  ...
  SECTION("Zero shift preserves every lane")
  {
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x3f, 0, 0, 2, 3));
    REQUIRE(core.generalRegister(3) == target);
  }
  ...
  SECTION("Maximum arithmetic shift broadcasts each sign")
  {
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x3f, 31, 0, 2, 3));
    REQUIRE(
      core.generalRegister(3) ==
      EERegister128{UINT64_C(0xffffffff00000000),
                    UINT64_C(0xffffffff00000000)});
  }
  ...
  SECTION("Target alias is safe and register zero is immutable")
  {
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x3e, 1, 0, 2, 2));
    REQUIRE(
      core.generalRegister(2) ==
      EERegister128{UINT64_C(0x4000000000000000),
                    UINT64_C(0x7f80007f3fffffff)});

    runInstruction(
      &system,
      nestedMmiInstruction(0x3c, 1, 0, 2, 0));
    REQUIRE(core.generalRegister(0) == EERegister128{});
  }
  ...
  SECTION("Repeated execution replaces every destination lane")
  {
    ...
    runInstruction(
      &system,
      nestedMmiInstruction(0x3c, 1, 0, 2, 3));
