...
class VPU : public ClockedComponent, public PipelineHandler
{
  public:
    ...
    uint16_t statusFlagsValue() const;
    uint16_t macFlagsValue() const;
    uint32_t clippingFlagsValue() const;
    uint32_t randomRegisterValue() const;
    uint32_t iRegisterBits() const;
    uint16_t callAddressRegister() const;
    void setStatusFlagsValue(uint32_t value);
    void setClippingFlagsValue(uint32_t value);
    void setRandomRegisterValue(uint32_t value);
    void setIRegisterBits(uint32_t value);
    void setQRegisterBits(uint32_t value);
    void setCallAddressRegister(uint32_t value);
    void resetFromControl();
    bool stoppedByDBit() const;
    bool stoppedByTBit() const;
    bool stoppedByForceBreak() const;
    bool divisionUnitBusy() const;
    bool elementaryFunctionUnitBusy() const;
    bool waitingForXGKICK() const;
    bool cop2WriteAvailable() const;
