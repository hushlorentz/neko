...
enum class EEOperation : std::uint8_t
{
  ...
  ParallelShiftLeftLogicalVariableWord,
  ParallelShiftRightLogicalVariableWord,
  ParallelShiftRightArithmeticVariableWord,
  QuadwordFunnelShiftRightVariable,
  ...
  ParallelMultiplyHalfword,
  ParallelMultiplyAddHalfword,
